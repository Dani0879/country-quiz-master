# Country Quiz - React Application
...
### Stack Obligatorio ✅
- **React Router v6** - Sistema de enrutamiento completo
- **Tailwind CSS** - Estilos responsive y dark mode

### Características Extras Obligatorias ✅
1. **Modo Contrarreloj (Timer)** - Temporizador regresivo de 15 segundos por pregunta
2. **Persistencia de Racha (High Score)** - Guardado en localStorage
3. **Modo Oscuro / Claro (Dark Mode)** - Switch de temas con Tailwind CSS `dark:` classes
4. **Efectos de Sonido** - Sonidos de éxito y error con Web Audio API

### Calidad y Testing ✅
- **ESLint** - Configurado y validando todo el código
- **4 Pruebas Unitarias** - Testing de componentes, estado y lógica:
  - QuizContext Tests - State management y localStorage
  - Quiz Component Tests - Timer y lógica de preguntas
...
✅ **React Router** - Modern client-side routing (Latest Version)
✅ **Tailwind CSS** - Responsive design and dark mode support
✅ **Timer Mode (Contrarreloj)** - 15-second countdown per question
✅ **High Score Persistence** - Saved to localStorage  
✅ **Dark Mode / Light Mode** - Native theme switching
